...
def extend_cfg(cfg):
    ...
    # Config for APOLLO
    cfg.TRAINER.APOLLO = CN()
    cfg.TRAINER.APOLLO.N_CTX = 2  # number of context vectors
    cfg.TRAINER.APOLLO.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.APOLLO.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.APOLLO.PROMPT_DEPTH = 9 # Max 12, minimum 0
    ...
    cfg.TRAINER.IVLP.PROMPT_DEPTH_VISION = 9 # Max 12, minimum 0
    cfg.TRAINER.IVLP.PROMPT_DEPTH_TEXT = 9  # Max 12, minimum 0
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
